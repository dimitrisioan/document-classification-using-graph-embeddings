...
if __name__ == '__main__':
    ...
    print(model.most_similar('man', topn=10))
    ...
    for category in os.listdir(parsed_path):
        ...
        for file in os.listdir(category_path):
            ...
            with open(file_path, "r") as text_file:
                ...
                words_found_vectors = [model.get_vector(word) for word in words if word in model.key_to_index]
    ...
    # Save the CSV file for Word2Vec Google pretrained model to the corresponding dataset directory
    df.to_csv(os.path.join(load_save_path, f'{prefix}_embeddings_word2vec_google.csv'), index=False)

    # df.to_csv("data_for_classifiers_word2vec_google.csv", index=False)
